...
const estimateClaims = [
  ['ground_force_personnel',104000,'personnel','estimated operational total'],
...
const poolDefs = [
  ...
  ['reserve_personnel','Armed forces reserve personnel unresolved opening pool','joint','reserve','joint','reserve personnel','organization_twn_reserve_command','person',['claim_twn_2025_reported_conscripts_entered_reserve_2047']],
  ...
  ['training_capacity','National training unresolved opening capacity','joint','training','joint','training capacity','organization_twn_general_staff_headquarters','capacity_unit',['claim_twn_2024_conscript_intake_6956']],
...
manifest.dataset_paths.claims = undefined;
...
manifest.reconciliation.exact_quantity_records = 0;
manifest.reconciliation.range_quantity_records = 0;
manifest.reconciliation.unknown_quantity_records = inventory.length;
manifest.reconciliation.expired_records = 0;
manifest.unknowns = [
